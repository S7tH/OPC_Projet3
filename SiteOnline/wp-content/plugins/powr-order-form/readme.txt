...
<br>
<br>
First, download, install, and activate POWr Order Form. Then drop the plugin anywhere in your theme. Or add to a page/post with the POWr icon in the WP editor.
<br>
= <a href='https://www.powr.io/tutorials/how-to-add-order-form-plugin-to-your-wordpress-site'>Click Here for 2 Minute Install Tutorial</a> =
<br>
= Free Features =
...
<br>
= <a href='http://www.powr.io/tutorials/how-to-add-order-form-plugin-to-your-wordpress-site'>Click Here for 2 Minute Install Tutorial</a> =
...
= How do I add Order Form to a page or blog post? = Create and save the plugin in your WP Dashboard.  Then copy and paste the unique shortcode into any page or post. You can continue editing the plugin on your live page, in your WP Dashboard, or by logging in to www.powr.io.

= How do I add Order Form to a theme?  = In your WP Dashboard, select Appearance > Widgets from the left sidebar. Find Order Form under Available Widgets and drag it into a sidebar or footer.  Then visit the live page to set up the plugin.

= Can I add more than one Order Form? = Yes, absolutely!  To clone an existing Order Form, paste the exact same unique shortcode into another page or post.  To create a new version, select Order Form from the sidebar in your WP Dashboard and click Create New.  You can then edit and save a new version, and paste the new unique shortcode into a page or post.

= Will my users see the Edit button above Order Form? = No! You only see the Edit button because you own the plugin. To temporarily hide it, click on your page and then type 'p + down arrow' (the letter p followed by the down arrow). You can show the icon again by typing 'p + up-arrow'.
